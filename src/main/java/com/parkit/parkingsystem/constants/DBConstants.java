...
public class DBConstants {
    ...
    public static final String GET_RECURRING_VEHICLE = "select ID from ticket where VEHICLE_REG_NUMBER=? and OUT_TIME is not null" ;
    public static final String UPDATE_FAKE_IN_TIME = "update ticket set IN_TIME=? where ID=?" ;
